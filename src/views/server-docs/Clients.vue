...
&lt;<span class="keyword">dependency</span>&gt;
  ...
  &lt;<span class="keyword">version</span>&gt;<span class="string">0.1.4</span>&lt;/<span class="keyword">version</span>&gt;
&lt;/<span class="keyword">dependency</span>&gt;</code></pre>
      <pre><code><span class="comment">// Gradle (Kotlin DSL)</span>
implementation(<span class="string">"io.blite:blite-client-java:0.1.4"</span>)</code></pre>
