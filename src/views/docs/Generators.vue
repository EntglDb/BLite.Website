...
<span class="keyword">public class</span> <span class="type">Customer</span>
{
    ...
    <span class="keyword">public</span> <span class="type">Dictionary</span>&lt;<span class="keyword">string</span>, <span class="type">List</span>&lt;<span class="keyword">int</span>&gt;&gt; Metadata { <span class="keyword">get</span>; <span class="keyword">set</span>; }
      ...
      <div class="info-box success">
        <strong>✨ Recent Improvements (v1.3.0 – v3.7.0):</strong>
        <ul>
          <li>✅ <strong>v3.7.0</strong> — <strong>OLAP aggregation pipeline</strong>: Top-N index-assisted queries (<code>ORDER BY + TAKE</code> without full scan), GroupBy aggregation, Range predicates on numeric fields, and aggregation pipeline performance pass. BLite.Server v0.2.1 compatibility.</li>
          <li>✅ <strong>v3.7.0</strong> — <strong>BLite.Server public preview</strong>: first preview release of BLite.Server — gRPC + REST network server, Blazor Web Studio, multi-tenancy, API-key auth, TypeScript and Java client SDKs.</li>
