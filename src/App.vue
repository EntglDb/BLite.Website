    ...
    <footer class="main-footer">
      <div class="container footer-inner">
        ...
        <div class="footer-col footer-downloads">
          <p class="footer-dl-title">⬇ Download BLite Studio v3.8.0</p>
          <div class="footer-dl-links">
            <a href="https://github.com/EntglDb/BLite/releases/download/studio-v3.8.0/BLite.Studio-3.8.0-win-x64.msi">🪟 Windows MSI</a>
            <a href="https://github.com/EntglDb/BLite/releases/download/studio-v3.8.0/BLite.Studio-3.8.0-win-x64-portable.zip">🪟 Windows Portable</a>
            <a href="https://github.com/EntglDb/BLite/releases/download/studio-v3.8.0/blite-studio_3.8.0_amd64.deb">🐧 Linux .deb</a>
            <a href="https://github.com/EntglDb/BLite/releases/download/studio-v3.8.0/BLite.Studio-3.8.0-linux-x64.tar.gz">🐧 Linux tar.gz</a>
            <a href="https://github.com/EntglDb/BLite/releases/download/studio-v3.8.0/BLite.Studio-3.8.0-osx-arm64.dmg">🍎 macOS Apple Silicon</a>
            <a href="https://github.com/EntglDb/BLite/releases/download/studio-v3.8.0/BLite.Studio-3.8.0-osx-x64.dmg">🍎 macOS Intel</a>
          </div>
        </div>
      </div>
    </footer>
