    ...
    <footer class="main-footer">
      <div class="container footer-inner">
        ...
        <div class="footer-col footer-downloads">
          <p class="footer-dl-title">⬇ Download BLite Studio v5.0.2</p>
          <div class="footer-dl-links">
            <a href="https://github.com/EntglDb/BLite/releases/download/studio-v5.0.2/BLite.Studio-5.0.2-win-x64.msi">🧻 Windows MSI</a>
            <a href="https://github.com/EntglDb/BLite/releases/download/studio-v5.0.2/BLite.Studio-5.0.2-win-x64-portable.zip">🧻 Windows Portable</a>
            <a href="https://github.com/EntglDb/BLite/releases/download/studio-v5.0.2/blite-studio_5.0.2_amd64.deb">🐧 Linux .deb</a>
            <a href="https://github.com/EntglDb/BLite/releases/download/studio-v5.0.2/BLite.Studio-5.0.2-linux-x64.tar.gz">🐧 Linux tar.gz</a>
            <a href="https://github.com/EntglDb/BLite/releases/download/studio-v5.0.2/BLite.Studio-5.0.2-osx-arm64.dmg">🍎 macOS Apple Silicon</a>
            <a href="https://github.com/EntglDb/BLite/releases/download/studio-v5.0.2/BLite.Studio-5.0.2-osx-x64.dmg">🍎 macOS Intel</a>
          </div>
        </div>
      </div>
    </footer>
